    ...
    sections: [
      {
        ...
        items: [
          ...
          "공방합 = AP·AAP 중 높은 값 + DP 입니다. 레벨 60 이상, 내실(일지·영구 보상)을 모두 마친 기준으로 계산합니다.",
      ...
      },
      {
        heading: "정렬 바꾸기",
        items: [
          "공방합 · AP · AAP · DP · 닉네임 · 길드 · 제출 시각 중 하나를 누르면 그 기준으로 줄을 세웁니다.",
          "길드로 줄을 세우면 같은 길드끼리 묶이고, 그 안에서는 공방합이 높은 사람이 위로 옵니다.",
          "보고 있던 기준을 다시 누르면 방향이 뒤집힙니다. 화살표가 지금 방향을 가리킵니다.",
          "수치가 확인되지 않는 제출은 공방합·AP·AAP·DP 로 볼 때만 맨 뒤로 갑니다. 닉네임이나 제출 시각으로 볼 때는 제자리에 섞입니다.",
      ...
      },
      {
        ...
        items: [
          "제출한 순간의 장비가 그대로 저장됩니다. 그 뒤에 본인이 세팅을 고쳐도 여기 보이는 것은 바뀌지 않습니다.",
      ...
      },
      {
        heading: "명단 복사",
        items: [
          "순위 · 닉네임 · 공방합 · AP/AAP/DP · 세팅 이름을 줄 단위로 복사합니다. 디스코드에 그대로 붙여 넣을 수 있습니다.",
        ],
      },
    ],
  },
