    ...
    sections: [
      {
        ...
        items: [
          ...
          "공방합 = 그 사람의 직업이 쓰는 공격력 + DP 입니다. 전승은 주무기, 각성은 각성무기, 기타(개방·재능)는 각성무기를 보되 데드아이·세라핌·샤이·오공만 주무기를 봅니다.",
      ...
      },
      {
        heading: "정렬 바꾸기",
        items: [
          "공방합 · 주무기 · 각성무기 · DP · 닉네임 · 길드 · 제출 시각 중 하나를 누르면 그 기준으로 줄을 세웁니다.",
          "길드로 줄을 세우면 같은 길드끼리 묶이고, 그 안에서는 공방합이 높은 사람이 위로 옵니다.",
          "보고 있던 기준을 다시 누르면 방향이 뒤집힙니다. 화살표가 지금 방향을 가리킵니다.",
          "수치가 확인되지 않는 제출은 공방합·주무기·각성무기·DP 로 볼 때만 맨 뒤로 갑니다. 닉네임이나 제출 시각으로 볼 때는 제자리에 섞입니다.",
